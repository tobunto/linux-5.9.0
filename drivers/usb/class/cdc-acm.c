...
#define NEOWAY_PRODUCT_N720V5 0x8247

bool detected_neoway_product(struct usb_device *dev)
{
	if (dev == NULL)
		return false;
	if (le16_to_cpu(dev->descriptor.idVendor) == NEOWAY_VENDOR_ID && le16_to_cpu(dev->descriptor.idProduct) == NEOWAY_PRODUCT_N720V5)
		return true;
...
static const struct usb_device_id acm_ids[] = {
	...
	{ USB_DEVICE(0x2949, 0x8247)}, //N720V5
